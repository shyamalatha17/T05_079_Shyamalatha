3) IDE (integrated development environment)::
    ...
    It is a software tool that  a programmer use  to write and test the program and software ,
while the IDLE is the IDE for the python . IDE is a software environment which usually consist
of a software development package containing code editor,build automation.
...
6) Ctrl-b - Moves cursor back one character
